...
//                                    SharedPreference.getmInstance(MainActivity.this).saveUser(loginResponse.getUser());
//                                    SharedPreference.setLoggedInUser(getBaseContext(), SharedPreference.getRegisteredUser(getBaseContext()));
//                                    SharedPreference.setLoggedInStatus(getBaseContext(), true);
