                ...
                ad.setTitle("PERINGATAN!").setMessage("Yakin Ingin Mengubah Data Ini?\nPeriksa Kembali Data Sebelum Diubah")
                        ...
                        .setPositiveButton("Ubah", new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int which) {
                                final ProgressDialog progressDialog = new ProgressDialog(EditKabupatenActivity.this);
            ...
            public void onClick(View v) {
                ...
                al.setTitle("PERINGATAN!").setMessage("Yakin Ingin Menghapus Data Ini?")
                        ...
                        .setPositiveButton("Hapus", new DialogInterface.OnClickListener() {
                            @Override
                            public void onClick(DialogInterface dialog, int which) {
                                final ProgressDialog progressDialog1 = new ProgressDialog(EditKabupatenActivity.this);
