...
public class ShowMapsAllMhsActivity extends FragmentActivity implements OnMapReadyCallback {

    private GoogleMap mMap;
    private List<Mahasiswa> mahasiswaList;
    private TextView txtNimMhs;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_show_maps_all_mhs);
        ...
        txtNimMhs.setText(intent.getStringExtra("nim"));
        txtNimMhs.setKeyListener(txtNimMhs.getKeyListener());
        txtNimMhs.setKeyListener(null);
    }
    ...
    private void getDataLocationFromDb(){
        ...
        String nim = txtNimMhs.getText().toString();
        ...
        call.enqueue(new Callback<MahasiswaResponse>() {
            ...
            public void onFailure(Call<MahasiswaResponse> call, Throwable t) {
                progressDialog.dismiss();
                Toast.makeText(ShowMapsAllMhsActivity.this, t.getMessage(), Toast.LENGTH_SHORT).show();
            }
        });
    }
